...
-- The Lua interpreter was compiled to a SWF with CrossBridge SDK (http://www.github.com/crossbridge-community)
-- 
...
function starlingUpdate()
  ...
  if loading and imgsloaded == 2 then
    setupWorld()
    loading = false
    flash.trace('LUAGame::imgsLoadedSuccess')
  end
